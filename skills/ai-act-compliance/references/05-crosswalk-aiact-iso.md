...
| **Art. 15(5)** + Recital 76 | **Cybersecurity** | cl. 8.1, A.6.2.4 | A.6.2.4, A.6.2.6, A.10.3 (suppliers) | **All sections** (whole standard) | **ISO/IEC 27090 (FDIS)** (depth), 27001/27002 baseline, NIST AI 100-2, OWASP LLM Top 10 | Strong: 27090 is depth standard for Recital 76 named threats |
